...
export default {
  ...
  assets: {
    ...
    'register/index.html': {size: 11130, hash: 'a103191ff6325b3977e76e6f968b22ade722d4aaf6f2a22194535470442fe9e4', text: () => import('./assets-chunks/register_index_html.mjs').then(m => m.default)},
